...
const (
	FormTypeTextSingleLine = "text_single_line"
	FormTypeNumber         = "number"
	FormTypeSingleSelect   = "single_select"
	FormTypeDate           = "date"
)

var formTypeAliasToCanonical = map[string]string{
	"text_single_line": FormTypeTextSingleLine,
	"single_line_text": FormTypeTextSingleLine,
	"text":             FormTypeTextSingleLine,
	"string":           FormTypeTextSingleLine,

	"number": FormTypeNumber,

	"single_select": FormTypeSingleSelect,
	"select":        FormTypeSingleSelect,
	"dropdown":      FormTypeSingleSelect,
	"single_choice": FormTypeSingleSelect,
