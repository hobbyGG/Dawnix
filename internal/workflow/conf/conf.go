...
func (b *Bootstrap) ApplyDefaults() {
	...
	if b.Auth.JWT.Secret == "" {
		b.Auth.JWT.Secret = "dawnix-dev-jwt-secret"
	}
	if b.Auth.JWT.Issuer == "" {
		b.Auth.JWT.Issuer = "dawnix"
	}
	if b.Auth.JWT.ExpireMinutes <= 0 {
		b.Auth.JWT.ExpireMinutes = 120
	}
}
